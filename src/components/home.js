  ...
  return (
    <div className="home">
      ...
      <div className="prediction_history">
        <button>See Prediction History</button>
      </div>
        ...
        <div className="testimonials">
          ...
          <div className="testimonial">
            ...
            <div className="message">
              <span>DICKSON</span>
              <span>
                For sure this app can make one rich trust me. Can’t imagine how
                I’ve been minting cash from sports betting. Keep it up guys
              </span>
            </div>
          </div>
          <hr />
      ...
      <div>
        <div>
          ...
          <p>Subscribe to BetTips for winning tips. Your win is our success.</p>
        </div>
        ...
        <ul className="FAQs">
          ...
          <li>
            ...
            <p>
              Our experts are dedicated to find the best odds and safest games.
              We make sure all the daily odds have 300% profits.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              will make our subscribers to lose their money. For this, we strive
              for constant profitability.
            </p>
          </li>
        </ul>
      </div>
